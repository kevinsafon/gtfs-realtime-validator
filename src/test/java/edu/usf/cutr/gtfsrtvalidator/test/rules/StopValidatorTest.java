...
public class StopValidatorTest extends FeedMessageTest {
    ...
    public void testStopIdValidation() {
        ...
        expectedErrorsWarnings.put(E011, 1);
        TestUtils.assertResults(expectedErrorsWarnings, results);
        ...
        expectedErrorsWarnings.put(E011, 2);
        TestUtils.assertResults(expectedErrorsWarnings, results);
        ...
        expectedErrorsWarnings.put(E011, 3);
        TestUtils.assertResults(expectedErrorsWarnings, results);
    ...
    public void testStopLocationTypeValidation() {
        ...
        expectedErrorsWarnings.put(E015, 1);
        TestUtils.assertResults(expectedErrorsWarnings, results);
        ...
        expectedErrorsWarnings.put(E015, 2);
        TestUtils.assertResults(expectedErrorsWarnings, results);
        ...
        expectedErrorsWarnings.put(E015, 3);
        TestUtils.assertResults(expectedErrorsWarnings, results);
